...
## Правило CTA для всего сайта

- Основной CTA всегда синий: фон `#2563EB`, hover `#1D4ED8`, белый текст. Это правило действует для кнопок записи, связи, отправки и принятия действия.
- Outline-CTA использует синий контур и синий текст; заливка при наведении — очень светло-синяя.
- Красный цвет не используется для CTA: он зарезервирован для предупреждений и ошибок.
